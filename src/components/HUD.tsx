  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center pointer-events-none">
      <div
        className={`
          relative
          flex w-[248px] items-center gap-3 rounded-full bg-neutral-900/90 p-2
          backdrop-blur-xl
          pointer-events-auto
              ...
              <div className="flex w-full flex-col gap-1 px-1">
                <div className="flex items-center justify-between gap-2">
                  ...
                  {processingTotalStages === 2 && currentProcessingIndex >= 0 && (
                    <span className="rounded-full border border-indigo-400/30 bg-indigo-500/10 px-1.5 py-0.5 text-[10px] font-medium text-indigo-200">
                  ...
                  {visibleProcessingSteps.map((step, index) => {
                    ...
                    return (
                      <div
                        key={step}
                        className={`
                          flex-1 rounded-full border px-2 py-1 text-center text-[10px] font-medium transition-colors
                          ${
                            isCurrent ? 'border-indigo-400/40 bg-indigo-500/15 text-indigo-100' : ''
                          }
