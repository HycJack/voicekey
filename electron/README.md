...
- `audio/` - 音频处理流水线（录音会话、转换、ASR、文本润色、注入）
...
- `refine/` - 文本润色模块（手动 OpenAI-compatible 配置、请求解析与连接测试）
...
- `constants.ts` - 应用级常量（GLM API 预设、通用 Chat 默认参数、默认快捷键、音频参数）
